...
from ie_tool import prediction
from ie_tool.entities import Document, Dataset, EntityType
from ie_tool.input_reader import BaseInputReader
from ie_tool.opt import jinja2
